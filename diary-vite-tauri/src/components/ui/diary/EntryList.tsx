...
export default function EntryList() {
    return (
        <div className="mx-auto max-w-xl lg:max-w-4xl flex-1 pt-36 px-8">
            <div className="text-black">
                <h1>Journal Entries</h1>
                <p>Track your daily thoughts and wellbeing</p>
            </div>

            <div className="mt-5 flex cursor-pointer text-white items-center justify-between rounded-xl bg-indigo-600 p-6">
                <div>
                    <h3>Today, 10 Apr</h3>
                ...
                <div className="entry mt-4">
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-3">
                            <h4 className="text-lg font-bold text-black text-nowrap">
                                Today, Apr 10
                            </h4>
                            <span className="rounded bg-indigo-600 px-1.5 py-0.5 text-xs text-nowrap text-white uppercase">
                                Just Now
                            </span>
                        </div>
                        <span className="aspect-square w-2 rounded-full bg-gray-300"></span>
                        <div className="flex cursor-pointer items-center gap-1 rounded bg-indigo-100 px-2 py-0.5 text-sm font-bold tracking-wide text-indigo-600 uppercase transition-colors hover:bg-indigo-100/70">
